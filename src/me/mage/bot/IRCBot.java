...
import me.mage.bot.customcommands.CustomCommandParser;
import me.mage.bot.database.Database;
import me.mage.bot.twitch.TwitchUtilities;
import me.mage.bot.util.DelayedPermitTask;
import me.mage.bot.util.DelayedReJoin;
import me.mage.bot.util.DelayedWelcomeTask;
import me.mage.bot.util.PointsRunnable;
...
public class IRCBot extends PircBot {
	...
	private static HashMap<String, me.mage.bot.util.PollUtil> polls;
	private static HashMap<String, me.mage.bot.util.RaffleUtil> raffles;
	private static HashMap<String, me.mage.bot.util.VoteTimeOutUtill> voteTimeOuts;
	 ...
	 *            - the Poll Object
	 */
	public void addPoll(String channel, me.mage.bot.util.PollUtil poll) {
	 ...
	 */
	public me.mage.bot.util.PollUtil getPoll(String channel) {
	 ...
	 *            - the Raffle Object
	 */
	public void addRaffle(String channel, me.mage.bot.util.RaffleUtil raffle) {
	 ...
	 */
	public me.mage.bot.util.RaffleUtil getRaffle(String channel) {
	...
	public void addVoteTimeOut(String channel,
			me.mage.bot.util.VoteTimeOutUtill voteTimeOut) {
	 ...
	 */
	public me.mage.bot.util.VoteTimeOutUtill getVoteTimeOut(
			String channel) {
